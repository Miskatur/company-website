...
const FirstBlock = ({ data, imageurl }) => {
  ...
  const {
    ...
    about_first_section_description = "Contrasted dissimilar get joy you instrument out reasonably...",
      ...
      <div className="row">
        ...
        <div className="col-lg-6 about-style-two pl-50 pl-md-15 pl-xs-15 mt-60 mt-xs-40 ps-lg-5 d-flex flex-column justify-content-center align-items-start">
          <div className="about-two-info">
            ...
            <h2 className="title">{about_first_section_title}</h2>
            ...
            <div className="about-grid-info">
              ...
              <ul className="list-info-item">
                <li>
                  <h4><Link href="#">Design <i className="fa-solid fa-angle-right"></i></Link></h4>
                </li>
                <li>
                  <h4><Link href="#">Digital Solution <i className="fa-solid fa-angle-right"></i></Link></h4>
                </li>
                <li>
                  <h4><Link href="#">Strategy <i className="fa-solid fa-angle-right"></i></Link></h4>
                </li>
                <li>
                  <h4><Link href="#">Branding <i className="fa-solid fa-angle-right"></i></Link></h4>
                </li>
              </ul>
            </div>
          </div>
